...
func (UnimplementedSqlBuilderApiServer) AnalyzeTemplate(context.Context, *AnalyzeTemplateRequest) (*CommonResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnalyzeTemplate not implemented")
}
...
func RegisterSqlBuilderApiServer(s grpc.ServiceRegistrar, srv SqlBuilderApiServer) {
	// If the following call panics, it indicates UnimplementedSqlBuilderApiServer was
